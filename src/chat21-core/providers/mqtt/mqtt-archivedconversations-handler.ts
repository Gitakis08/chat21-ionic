...
export class MQTTArchivedConversationsHandler extends ArchivedConversationsHandlerService {
    ...
    public getConversationDetail(conversationWith: string, callback) {
        ...
        if (conversation) {
            this.logger.debug('[MQTTArchivedConversationsHandler] getConversationDetail found locally');
    ...
    private added(childSnapshot: any) {
        ...
        if (this.isValidConversation(conversation)) {
            ...
            this.logger.debug('[MQTTArchivedConversationsHandler] conversation uid:', conversation.uid)
            if (index > -1) {
